...
open class GradleDistributionsPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project): Unit = project.run {
        ...
        val binZip by tasks.registering(Zip::class) {
        ...
        consumableVariant("distributionBinZip", "gradle-distribution-zip", Bundling.EMBEDDED, emptyList(), binZip)
    }
